...
config: {
 ...
 onStart: async function ({  }) { },
  ...
  var Messages = [ "সুন্দর মাইয়া মানেই-🥱-আমার বস রবিউল এর বউ-😽🫶-আর বাকি গুলো আমার বেয়াইন-🙈🐸🤗", "-কিরে-🫵-তরা নাকি  prem করস-😐🐸-আমারে একটা করাই দিলে কি হয়-🥺",  "Bot বলে অসম্মান করচ্ছিছ,😰😿"  "-হুদাই আমারে  শয়তানে লারে-😝😑☹️", "- বেডি মানুষ বড় ভেজাইল্লা🤧🔪", "⎯তো্ঁর্ঁ ন্ঁজ্ঁরে্ঁ স্ঁম্ঁস্যা্ঁ আ্ঁছে্ঁ  ন্ঁজ্ঁর্ঁ ঠি্ঁক্ঁ ক্ঁর্ঁ-🐸🫣⎯⃝''", "-চু্ঁপ্ঁ থা্ঁক্ঁ তু্ঁই্ঁ 🫵 বি্ঁছা্ঁনা্ঁয়্ঁ মু্ঁতো্ঁস্ঁ 😽⎯͢⎯⃝🩷🍒🙂","___মন দে !🙂🫴---ছিনি মিনি খেলমু 🤭🤭", "- ওই 🫵 তোমারে প্রচুর ভাল্লাগে-😽-সময় মতো প্রপোজ করমু বুঝছো-🔨😼-ছিট খালি রাইখো- 🥱🐸🥵", "-আপনার সুন্দরী বান্ধুবীকে ফিতরা হিসেবে আমার বস রবিউল কে দান করেন-🥱🐰🍒", "-ইস কেউ যদি বলতো-🙂-আমার শুধু  তোমাকেই লাগবে-💜🌸","-অনুমতি দিলাম-𝙋𝙧𝙤𝙥𝙤𝙨𝙚 কর বস রবিউল কে-🐸😾🔪", "-প্রিয়-🥺 -তোমাকে না পেলে আমি সত্যি-😪 -আরেকজন কে-😼 -পটাতে বাধ্য হবো-😑🤧","- দুনিয়ার সবাই প্রেম করে.!🤧 -আর মানুষ আমার বস রবিউল কে সন্দেহ করে.!🐸",]
